...
class _CartApiClient implements CartApiClient {
  ...
  @override
  Future<CartResponseModel> addToCartApi(AddCartRQM cartRqm) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(cartRqm.toJson());
  ...
  @override
  Future<List<Cart>> getUserCart(int id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result =
        await _dio.fetch<List<dynamic>>(_setStreamType<List<Cart>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
